...
export function About() {
  return (
    <section id="about" className="py-16 sm:py-24 bg-secondary/30 border-y border-white/5 relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          >
            <div className="aspect-square rounded-full border border-white/10 flex items-center justify-center p-8 relative">
              ...
              <div className="absolute inset-[15%] rounded-full bg-secondary flex items-center justify-center shadow-2xl">
