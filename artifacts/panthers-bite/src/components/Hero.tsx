    ...
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center py-12 sm:py-0">
        ...
        >
          ...
          <div className="mt-8 sm:mt-12 flex items-center gap-6 text-sm font-semibold uppercase tracking-wider text-muted-foreground justify-center sm:justify-start">
